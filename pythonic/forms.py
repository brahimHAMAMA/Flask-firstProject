...
class RegistrationForm(FlaskForm):
    fname = StringField('First Name', validators=[DataRequired(), Length(min=5, max=25)])
    lname = StringField('Last Name', validators=[DataRequired(), Length(min=5, max=25)])
    ...
    def validate_username(self, username):
        ...
        if user:
            raise ValidationError('Username alredy exists! Please chosse a differnt one')
